...
export const ORDER_STATUS_MAP = {
  calculating_estimates: (
    <FormattedMessage id="status.calculatingEstimates" defaultMessage="Calculating Estimates" />
  ),
...
export const EVENT_KEY_MAPPING = {
  ...
  currency: (
    <FormattedMessage id="field.currency" defaultMessage="Currency" />
  ),
  customer_email: (
    <FormattedMessage id="field.customerEmail" defaultMessage="Customer Email" />
  ),
  due_date: (
    <FormattedMessage id="field.dueDate" defaultMessage="Due Date" />
  ),
  itar: (
    <FormattedMessage id="field.itar" defaultMessage="Itar" />
  ),
  model: (
    <FormattedMessage id="model" defaultMessage="Model" />
  ),
  model_permission: (
    <FormattedMessage id="event.modelPermission" defaultMessage="Model Permission" />
  ),
  name: (
  ...
  shipping_address: (
    <FormattedMessage id="field.shippingAddress" defaultMessage="Shipping Address" />
  ),
  shipping_name: (
    <FormattedMessage id="field.shippingName" defaultMessage="Shipping Name" />
  ),
  shipping_tracking: (
    <FormattedMessage id="field.trackingNumber" defaultMessage="Tracking Number" />
  ),
  shipping_uuid: (
  ...
  third_party_provider: (
    <FormattedMessage id="field.thirdPartyProvider" defaultMessage="Third Party Provider" />
  ),
  user: (
