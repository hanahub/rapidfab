          ...
          <BS.Nav>
            <BS.NavDropdown eventKey={1} title={planTitle} id="uxNavPlan">
              ...
              <BS.MenuItem eventKey={1.4} href="#/plan/post-processing" style={{ display: 'none' }}>
                <Fa name="flask" />
                {' '}
                <FormattedMessage id="plan.postProcessing" defaultMessage="Post Processing" />
              </BS.MenuItem>
            </BS.NavDropdown>
            <BS.NavDropdown eventKey={2} title={workTitle} id="uxNavWork">
              ...
              <BS.MenuItem eventKey={2.3} href="#/work/third-party" style={{ display: 'none' }}>
                ...
                {' '}
                <FormattedMessage id="work.thirdParty" defaultMessage="Third Party" />
              </BS.MenuItem>
            </BS.NavDropdown>
            <BS.NavDropdown eventKey={3} title={inventoryTitle} id="uxNavInventory">
              <BS.MenuItem eventKey={3.1} href="#/inventory/stocks">
                <Fa name="tags" />
                {' '}
                <FormattedMessage id="inventory.materialStocks" defaultMessage="Material Stocks" />
              </BS.MenuItem>
              ...
              <BS.MenuItem eventKey={3.3} href="#/inventory/post-processors">
                ...
                {' '}
                <FormattedMessage id="inventory.postProcessors" defaultMessage="Post processors" />
              </BS.MenuItem>
              <BS.MenuItem divider />
              ...
              <BS.MenuItem eventKey={3.5} href="#/inventory/printer-types">
                <Fa name="print" />
                {' '}
                <FormattedMessage id="inventory.printerTypes" defaultMessage="Printer Types" />
              </BS.MenuItem>
              ...
              <BS.MenuItem eventKey={3.10} href="#/inventory/locations">
                <Fa name="map-marker" />
                {' '}
          ...
          <BS.Nav pullRight>
            ...
            <BS.NavDropdown eventKey={2} title={<Flag type={flag} />} id="uxNavLocale">
              <BS.MenuItem eventKey={2.1} onClick={() => onChangeLocale(locale, 'en-US')}>
                <Fa name="check" style={{ visibility: flag === 'us' ? null : 'hidden' }} />
                {' '}
                <Flag type="us" />
                {' '}
                English
              ...
              <BS.MenuItem eventKey={2.2} onClick={() => onChangeLocale(locale, 'ja')}>
                <Fa name="check" style={{ visibility: flag === 'jp' ? null : 'hidden' }} />
                {' '}
                <Flag type="jp" />
                {' '}
                日本語
