...
class MaterialResource extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <BS.Grid>
        ...
        <FormModal
          ...
          title={this.state.editingData ? "Edit Material Resource" : "New Material Resource"}
        >
          <Form />
        </FormModal>
        ...
        <BS.Row>
          <BS.Col xs={12}>
            <BS.Breadcrumb>
              ...
              <BS.Breadcrumb.Item href="#/inventory/material-resource">
                Material Resources
              </BS.Breadcrumb.Item>
            </BS.Breadcrumb>
          </BS.Col>
        ...
        <BS.Row>
          <BS.Col xs={12}>
            <Grid
              data={_.values(FakeData.material_resources)}
