  ...
  <BS.Row>
    <BS.Col xs={12}>
      ...
      <BS.FormGroup controlId="uxPhone">
        <BS.ControlLabel><FormattedMessage id="field.phone" defaultMessage='Phone'/>:</BS.ControlLabel>
      ...
      <BS.Table bordered hover>
        <thead>
          <tr>
            ...
            <th><FormattedMessage id="field.manufacturer" defaultMessage='Manufacturer'/></th>
          </tr>
        </thead>
        <tbody>
          <tr>
