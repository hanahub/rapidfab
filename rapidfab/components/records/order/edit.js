...
const EditForm = ({ fields, handleSubmit, load, submitting, onDelete, materials}) => (
      ...
      <BS.Row>
        <BS.Col xs={12}>
          ...
          <BS.FormGroup controlId="uxBaseMaterials">
            ...
            <BS.FormControl componentClass="select" multiple required {...fields.base_materials}>
          ...
          <BS.FormGroup controlId="uxSupportMaterials">
            ...
            <BS.FormControl componentClass="select" multiple {...fields.support_materials}>
              {_.map(materials, material => (
                <option key={material.uri} value={material.uri}>{material.name}</option>
              ))}
            </BS.FormControl>
          ...
          <BS.FormGroup controlId="uxQuantity">
            ...
            <BS.FormControl type="text" required {...fields.quantity}/>
          </BS.FormGroup>
